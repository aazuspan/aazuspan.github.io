...
Slug: minifying-modules
Authors: Aaron Zuspan
Summary: Does minifying Earth Engine modules speed up imports? No, not really.
...
![Yes and no. Mostly no. Really, all no.](assets/mostly_no.gif)
...
![The browser can't tell the difference between minified and regular code.](assets/minified_same_picture.jpeg)
...
![Browser developer tools showing the GET request](assets/demo_traffic.png)
...
![File size decreased from 38.3 kB to 9.08 kB (76.27%)](./assets/code_size.png)
